...
const socket = io.connect("https://lifesaviourappbackend.onrender.com/");
...
export default function Dashboard() {
    ...
    const GetQuery = async function () {
        setIsLoading(true);
        try {
            const response = await axios.get(`https://lifesaviourappbackend.onrender.com/getquery/${user.email}/${user.role}`);
    ...
    const CloseQuery = async function (dr_email) {
        ...
        try {
            ...
            const response = await axios({
                method: "post",
                url: `https://lifesaviourappbackend.onrender.com/closequery`,
                params: {
                },
